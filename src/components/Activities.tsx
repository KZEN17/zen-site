      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <p className="text-gray-400 text-sm">
              Activities can be scheduled based on your preference and weather
              conditions.
            </p>
          </div>
          <div className="text-center p-6">
            ...
            <p className="text-gray-400 text-sm">
              All activities include safety equipment and experienced local
              guides.
            </p>
          </div>
          <div className="text-center p-6">
            ...
            <h4 className="text-lg font-semibold mb-2">Group Friendly</h4>
            <p className="text-gray-400 text-sm">
              Perfect for families, friends, and team buildings with group
              discounts available.
            </p>
          </div>
        </div>
        ...
        {expandedImage && (
          ...
          >
            ...
            {/* Navigation Buttons */}
            <button
              className="absolute left-6 top-1/2 -translate-y-1/2 text-white hover:text-amber-500 transition-colors z-50"
              onClick={(e) => {
                e.stopPropagation();
            ...
            <div className="flex flex-col items-center gap-4 max-w-4xl w-full">
              <img
                src={expandedImage.images[expandedImage.currentIndex]}
                alt={`Expanded view ${expandedImage.currentIndex + 1}`}
            ...
            <button
              className="absolute right-6 top-1/2 -translate-y-1/2 text-white hover:text-amber-500 transition-colors z-50"
              onClick={(e) => {
                e.stopPropagation();
                setExpandedImage((prev) => {
                  if (!prev) return null;
